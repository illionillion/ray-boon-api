...
const generateExampleV2 = async (apiKey, wordLang, wordName, wordMean, sentenceDiff) => {
  ...
  const completion = await openai.createChatCompletion({
    ...
    messages: [{ role: "user", content: `${wordLang}で${wordMean}という意味の${wordName}という単語があります。この単語を使った例文を${sentenceDiff}くらいの難易度で作ってください。また、その例文を日本語訳した文を出力してください。また、${wordLang}の言語コードを出力してください。` }],
    functions: [
      {
...
module.exports = generateExampleV2;